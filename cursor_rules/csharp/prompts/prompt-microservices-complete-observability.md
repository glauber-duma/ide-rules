...
Tarefa: gerar uma rule (.mdc) para projetos "microservicos completo sem uso de Dapr e com observabilidade".
A rule deve seguir o padrao do repositorio e ser compatível com VS Code e Cursor.

Requisitos:
- Use .NET 9 e C#.
- Use mensageria (RabbitMQ/Kafka), resiliencia com Polly, outbox, idempotencia.
