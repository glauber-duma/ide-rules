...
Tarefa: gerar uma rule (.mdc) para projetos "aplicacao console simples com observabilidade com foco em integracao de sistemas legados (processos batch)".
A rule deve seguir o padrao do repositorio e ser compatível com VS Code e Cursor.

Requisitos:
- Use .NET 9 e C#.
- Console app com processamento em lote, integracao legada, resiliencia simples.
...
alwaysApply: false
tags: ["csharp", "console", "batch", "observability"]
Author: Glauber Duma
Created: 2026-02
---
